...
actividad_3/
├── notebooks/
│   └── actividad3.ipynb          # Notebook principal con el análisis
├── src/
│   └── ml_pipeline/
...
cd ml-engineering-portfolio/workshop/actividad_3
...
```
Successfully installed actividad3-linear-regression-0.1.0
```

### Verificar la instalación

```bash
pip show actividad3-linear-regression
