...
def run(input_dir, output_dir, delete=False):
    """Convierte un lote de HEIC a JPG y deja constancia de la corrida.

    Es idempotente: lo que ya está convertido se salta. El original solo se
    borra si la conversión terminó bien, y nunca antes.
    """
